<template>
    <div id="login" :class="{ recaptcha: recaptcha }">
        <form @submit="submit">
            ...
            <p @click="toggleMode" v-if="signup">{{ createMode ? $t('login.loginInstead') : $t('login.createAnAccount')
                }}</p>
        </form>
    </div>
</template>
...
<script>
    ...
    import {name, logoURL, recaptcha, recaptchaKey, signup, external} from '@/utils/constants'
